...
export default function SharedReport() {
  ...
  const seoDescription = report
    ...
    : "View this security scan report powered by Seclayer — automated black-box security scanning for web applications.";
  useSeo({ title: seoTitle, description: seoDescription, canonical: `https://secscan.us/s/${token}` });
      ...
      {showPdfContainer && (
        ...
        >
          ...
          <div style={{ marginTop: "32px", paddingTop: "12px", borderTop: "1px solid #e5e7eb", textAlign: "center", color: "#9ca3af", fontSize: "11px" }}>
            Generated by Seclayer — https://secscan.us | {dateStr}
          </div>
        </div>
      )}
    </div>
