...
export default function SharedReport() {
  ...
  const seoTitle = report
    ? `Grade ${report.data.summary.grade} — ${(() => { try { return new URL(report.targetUrl).hostname; } catch { return report.targetUrl; } })()} | SecScan Security Report`
    : "Security Report — SecScan";
      ...
      <div className="mt-16 pt-8 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-4">
        <div className="text-center sm:text-left">
          <p className="text-xs text-muted-foreground">
            ...
            <a href="/" className="text-primary hover:underline font-semibold">SecScan</a>
      ...
      {showPdfContainer && (
        ...
        >
          ...
          <div style={{ marginTop: "32px", paddingTop: "12px", borderTop: "1px solid #e5e7eb", textAlign: "center", color: "#9ca3af", fontSize: "11px" }}>
            Generated by SecScan — {APP_ORIGIN} | {dateStr}
          </div>
        </div>
      )}
    </div>
